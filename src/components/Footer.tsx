  ...
  return (
    <footer className="bg-zinc-950 w-full border">
      <div className="container mx-auto px-4 flex flex-col items-center relative mt-10 ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 text-center mb-10 b">
          ...
          <div className="text-center hidden md:block mt-10">
            ...
            <div className="flex items-center bg-white  rounded-[14px]  mt-10">
              ...
              />
              <div className="w-10  h-[40px] bg-pink-400 rounded-tr-[14px] rounded-br-[14px] ml-2 cursor-pointer items-center justify-center">
                <img src="/svgs/send.svg" alt="" />
              </div>
            </div>
          </div>
          <div className="flex items-center text-center justify-center space-x-4 mt-10">
        ...
        <div className=" text-center text-stone-900 lg:text-[300px] text-5xl font-medium font-Roboto bottom-0 ">
          astrix
        </div>
      </div>
    </footer>
