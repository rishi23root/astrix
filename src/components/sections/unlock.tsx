...
export default function Unlock() {
  return (
    ...
    {/* Web Version */}
    <div className="web  w-[100%] h-auto flex-col justify-start items-center gap-[236px] inline-flex custom-bg">
      ...
      {/* Mobile Version */}
      <div className="lg:hidden w-full h-auto flex-col  justify-start items-center gap-[50px] inline-flex custom-bg">
